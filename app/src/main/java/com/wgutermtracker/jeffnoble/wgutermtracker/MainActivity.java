...
public class MainActivity extends AppCompatActivity
    ...
    //protected DBHandler dbHandler = new DBHandler(this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentClass = ContentMainFragment.class;
        try {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_terms) {
            fragmentClass = TermListFragment.class;
        } else if (id == R.id.nav_courses) {
            fragmentClass = CourseListFragment.class;
        } else if (id == R.id.nav_assessments) {
            fragmentClass = AssessmentListFragment.class;
        } else if (id == R.id.nav_home) {
            fragmentClass = ContentMainFragment.class;
        } else if (id == R.id.nav_create_term) {
            fragmentClass = TermCreateFragment.class;
        } else if (id == R.id.nav_create_course) {
            fragmentClass = CourseCreateFragment.class;
        }
